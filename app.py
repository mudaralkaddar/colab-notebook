...
logistic_regression = pickle.load(open('/app/Completed_llogistic_regression_model.joblib', 'rb'))
tree = pickle.load(open('/appcolab-notebook/Completed_Bayesian_model.joblib', 'rb'))
